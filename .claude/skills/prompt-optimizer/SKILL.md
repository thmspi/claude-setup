...
description: >-
  Analyze raw prompts, identify intent and gaps, match setup components
...
Analyze a draft prompt, critique it, match it to setup components,
...
- User is asking about setup configuration (use `setup-claude` instead)
...
Map intent + scope + tech stack (from Phase 0) to specific setup components.
...
- "Optimize this prompt for my setup"
...
|-----------|------------------|
| `setup-claude` | User hasn't finished setup yet |
